...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		System.out.println(family1.getPapaName());
		System.out.println(family1.getMamiName());
		System.out.println(family1.getSisterName());
		System.out.println(family1.getBrotherName());
